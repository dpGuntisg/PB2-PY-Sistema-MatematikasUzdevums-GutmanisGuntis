...
def teorija():
    ...
    sleep(2)
    print("Piemērs: Vienā šķīvī 5 dažādu šķirņu āboli, bet otrā – 4 dažādi bumbieri. Cik veidos var izvēlēties dažādu augļu pāri?  ")
    sleep(3)
    print("Risinājums. Katram izvēlētajam ābolam varam piekārtot 4 bumbierus no otrā šķīvja. Tātad kopā augļu pāri varam izvēlēties 5 * 4 = 20 veidos.")
